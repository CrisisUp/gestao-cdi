    ...
    <x-slot name="header">
        <div class="flex flex-wrap justify-between items-center gap-2">
            ...
            <a href="{{ route('admin.logs.export-csv', request()->query()) }}"
                class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold uppercase tracking-wider rounded-lg transition-colors">
